                ...
                <tr key={flight._id}>
                  ...
                  <td>
                    {flight.passengers.length > 5 ? (
                      `Ya tiene ${flight.passengers.length} personas más`
                    ) : (
                  ...
                  <td>
                    {flight.controls.map((control) => (
                      <div key={control._id}>
                        <p>{`${control.modelo} ${control.matricula} ${control.aerolinea}`}</p>
                      </div>
                    ))}
                  </td>
                  <td className='row-mt-3 col-2'>
                    <button
                      onClick={() => openModal(2, flight._id, flight.pilot, flight.airplane, flight.destinationCity, flight.flightDate)}
                    ...
                    &nbsp;
                    <button
                      onClick={() => eliminarflights(flight._id, flight.pilot)}
